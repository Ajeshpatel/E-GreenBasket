  ...
  const ProductCard = ({ product, isGridView = false }) => (
    <div
      ...
      className={`bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100 ${
        isGridView 
          ? "w-full" 
          : "min-w-[260px] max-w-[300px] flex-shrink-0 mx-2"
      }`}
    >
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="text-sm text-gray-600">
            ...
            {selectedCategory !== 'all' && (
              <span className="ml-2">in <span className="font-medium text-indigo-600">
      ...
      <div className="py-12">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm mb-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            ...
            <button
              onClick={() => setSelectedCategory('all')}
              className={`flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all ${selectedCategory === 'all' ? 'border-indigo-600 bg-indigo-50' : 'border-gray-200 hover:border-indigo-300'}`}
            >
            ...
            {categories.map((category) => (
              <button
                ...
                className={`flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all ${selectedCategory === category.slug ? 'border-indigo-600 bg-indigo-50' : 'border-gray-200 hover:border-indigo-300'}`}
              >
                <div className="bg-indigo-100 p-3 rounded-full mb-2 text-2xl">
                  {category.icon}
                </div>
